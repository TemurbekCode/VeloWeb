      ...
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        ...
        <div>
          <div style={{
            ...
            {/* Left — Visual (original design) */}
            <div style={{
              background: "#111",
              display: "flex", flexDirection: "column",
              alignItems: "center", justifyContent: "center",
              padding: 48, borderRight: "1px solid #1e1e1e",
              ...
              <div style={{
                ...
                color: "#C9A84C", borderRadius: 100, padding: "4px 12px",
                fontSize: 11, letterSpacing: 1, zIndex: 1,
              }}>
            ...
            <div style={{
              ...
              <div style={{
                ...
                color: "#C9A84C", borderRadius: 100, padding: "5px 14px",
                fontSize: 12, letterSpacing: 1, width: "fit-content",
              }}>
              ...
              <h3 style={{
                ...
                color: "#F0EAD8", margin: 0, lineHeight: 1.2,
              }}>
                {project.title}
              </h3>
              ...
              <p style={{ fontSize: 16, color: "#666", lineHeight: 1.8, margin: 0 }}>
                {project.desc}
              </p>
              ...
              {hasLink ? (
                <a
                  ...
                  style={{
                    ...
                    color: "#0A0A0A", padding: "13px 28px", borderRadius: 8,
                    fontWeight: 700, fontSize: 14, textDecoration: "none",
                    letterSpacing: 0.5, width: "fit-content", marginTop: 8,
                    boxShadow: "0 4px 24px rgba(201,168,76,0.25)", transition: "transform 0.2s",
                  }}
                ...
                <div style={{
                  ...
                  padding: "13px 28px", borderRadius: 8, fontWeight: 700,
                  fontSize: 14, letterSpacing: 0.5, width: "fit-content",
                  marginTop: 8, border: "1px dashed #2a2a2a", cursor: "not-allowed",
                }}>
                  🔒 {t.comingSoon}
                </div>
              )}
            ...
            <div style={{ display: "flex", gap: 8 }}>
              {list.map((_, i) => (
                <button key={i} onClick={() => goTo(i, i > current ? "right" : "left")} style={{
                  ...
                  background: i === current ? "linear-gradient(90deg, #C9A84C, #F5D98B)" : "#2a2a2a",
